            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user28') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user28/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user28') {
                    ...
                    openshift.tag("user28/gateway-canary:latest", "user28/gateway:latest")
